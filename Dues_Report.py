            ...
            if(len(thisCU) == 0):
                ...
                if (len(q1_adjs) == 0):
                    if (thisCU['STATUS'].loc[thisCU.index[0]] == 'Merged'):
                        ...
                        comments = 'Merged with ' + survivor_cu['NAME'].loc[survivor_cu.index[0]] + ' (' + thisCU['SURVIVOR_ID'].loc[thisCU.index[0]] + ') on ' + ''
